...
func get_root_delta_pos(animation : String, progress : float, delta : float) -> Vector3:
	var data = animation_player.get_animation(animation)
...
func get_transitions_to_queued(animation : String, timecode : float) -> bool:
	return animation_player.get_boolean_value(animation, "StateData:transitions_to_queued", timecode) 

func get_accepts_queueing(animation : String, timecode : float) -> bool:
	return animation_player.get_boolean_value(animation, "StateData:accepts_queueing", timecode) 

func get_vulnerable(animation : String, timecode : float) -> bool:
	return animation_player.get_boolean_value(animation, "StateData:is_vulnerable", timecode) 

func get_interruptable(animation : String, timecode : float) -> bool:
	return animation_player.get_boolean_value(animation, "StateData:is_interruptable", timecode) 

func get_parryable(animation : String, timecode : float) -> bool:
	return animation_player.get_boolean_value(animation, "StateData:is_parryable", timecode)
...
func get_right_weapon_hurts(animation : String, timecode : float) -> bool:
	return animation_player.get_boolean_value(animation, "StateData:right_hand_weapon_hurts", timecode)

func tracks_input_vector(animation : String, timecode : float) -> bool:
	return animation_player.get_boolean_value(animation, "StateData:tracks_input_vector", timecode)
